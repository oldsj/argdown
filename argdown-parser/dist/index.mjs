...
var matchIncomingSupport = partialRight(matchRelation, /^([' '\t]*)(\+>)/);
var matchIncomingAttack = partialRight(matchRelation, /^([' '\t]*)(->)/);
var matchOutgoingSupport = partialRight(matchRelation, /^([' '\t]*)(<?\+)/);
var matchOutgoingAttack = partialRight(matchRelation, /^([' '\t]*)(<?-)/);
var matchContradiction = partialRight(matchRelation, /^([' '\t]*)(><)/);
var matchIncomingUndercut = partialRight(matchRelation, /^([' '\t]*)(_>)/);
var matchOutgoingUndercut = partialRight(
  matchRelation,
  /^([' '\t]*)(<_|(?:_(?=\s)))/
);
...
var matchOrderedListItem = partialRight(
  matchListItem,
...
var matchUnorderedListItem = partialRight(
  matchListItem,
...
var matchAsteriskBoldStart = partialRight(
  matchBoldOrItalicStart,
  /^\*\*(?!\s)/,
  "AsteriskBold"
);
var matchAsteriskBoldEnd = partialRight(
  matchBoldOrItalicEnd,
  /^\*\*(?:[ \t]|(?=\n|\r|\)|\}|\_|\.|,|!|\?|;|:|-|\*|$))/,
  "AsteriskBold"
);
var matchUnderscoreBoldStart = partialRight(
  matchBoldOrItalicStart,
  /^__(?!\s)/,
  "UnderscoreBold"
);
var matchUnderscoreBoldEnd = partialRight(
  matchBoldOrItalicEnd,
  /^__(?:[ \t]|(?=\n|\r|\)|\}|\_|\.|,|!|\?|;|:|-|\*|$))/,
  "UnderscoreBold"
);
var matchAsteriskItalicStart = partialRight(
  matchBoldOrItalicStart,
  /^\*(?!\s)/,
  "AsteriskItalic"
);
var matchAsteriskItalicEnd = partialRight(
  matchBoldOrItalicEnd,
  /^\*(?:[ \t]|(?=\n|\r|\)|\}|\_|\.|,|!|\?|;|:|-|\*|$))/,
  "AsteriskItalic"
);
var matchUnderscoreItalicStart = partialRight(
  matchBoldOrItalicStart,
  /^\_(?!\s)/,
  "UnderscoreItalic"
);
var matchUnderscoreItalicEnd = partialRight(
  matchBoldOrItalicEnd,
  /^\_(?:[ \t]|(?=\n|\r|\)|\}|\_|\.|,|!|\?|;|:|-|\*|$))/,
  "UnderscoreItalic"
);
...
import * as chevrotain2 from "chevrotain";
...
// src/parser.ts
var ArgdownParser = class extends EmbeddedActionsParser {
  constructor() {
    super(tokenList, {
...
var ArgdownTreeWalker = class extends EventEmitter {
  constructor() {
    super(...arguments);
...
// src/index.ts
import { tokenMatcher as tokenMatcher5 } from "chevrotain";
